...
%-----       letter       ---------------------------------------------------------
% recipient data
\recipient{Shopify Recruitment Team}{Shopify\\150 Elgin Street\\Ottawa, Ontario}
...
\begin{enumerate}
    \item I have a \textbf{strong interest and enthusiasm in mathematics and 
        ...
        perfectly suited for tackling the problems that an Engineering 
        intern at Shopify will face. 
        \smallskip
    ...
    \item I have acquired a \textbf{modest amount of experience}. In particular, 
        ...
        an engineering position at Shopify.
\end{enumerate}
