...
\geometry{left=1cm,right=9cm,marginparwidth=7.0cm,marginparsep=1.2cm,top=2.25cm,bottom=1.25cm}
...
\begin{itemize}
    \item Automated stress testing on company products and networks using Python
    \item Developed custom TCP-interfacing implementations of IETF RFCs to 
        properly debug non standards-compliant network stacks
    \item Caught and reported multiple bugs and issues in Clojure code bases, 
...
\begin{itemize}
    \item Scraped statistics and metrics from across the web using Ruby to 
        interface with REST APIs
    \item Delivered data to clients through web interfaces constructed with Ruby 
        on Rails, HTML/CSS, and Javascript derivatives
\end{itemize}
