...
\geometry{left=1cm,right=8cm,marginparwidth=6.0cm,marginparsep=0.8cm,top=2.00cm,bottom=1.00cm}
...
\item Instrumented and completed an extensive porting undertaking from legacy Haskell codebases to 
    modern statically typed Python
\end{tightitemize}
...
\vspace{\topsep} % Hacky fix for awkward extra vertical space
\begin{tightitemize}
    \item Developed a pure functional Clojure metrics library to monitor complex JVM 
        architectures
    \item Implemented a parser and interpreter in Python for an 
        internally designed domain specific language tailored for specific 
...
\item Prepared careful individual tutoring lesson plans to ameliorate 
    understanding in advanced topics such as quadratic reciprocity or dependently typed 
