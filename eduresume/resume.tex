...
\cvevent{\textcolor{Cool}{\textbf{Ericsson}} \textcolor{LightGrey}{{::}}
Software Engineering Intern (Performance)}{\textrm{\textcolor{Mulberry}{\normalfont \cvtag{Clojure} 
...
\cvevent{\textcolor{Cool}{\textbf{CENX Inc}} \textcolor{LightGrey}{{::}}
Software Engineering Intern (Test Automation)}{\textrm{\textcolor{Mulberry}{\normalfont \cvtag{Python} 
...
\cvevent{\textcolor{Cool}{\textbf{inBay Technologies}} \textcolor{LightGrey}{{::}}
Software Engineering Intern (Full Stack)}{\textrm{\textcolor{Mulberry}{\normalfont 
...
\cvevent{\textcolor{Cool}{\textbf{University of Waterloo}} \textcolor{LightGrey}{{::}}
Algebra Teaching Assistant}{\textrm{\textcolor{Mulberry}{\normalfont 
